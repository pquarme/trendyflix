app.controller('searchController', function($scope, $location, cfpLoadingBar){
	$scope.pageTitle = "SEARCH";
	$scope.query = $location.search()['q']; //search query from url
	...
	$scope.getNextPage = function(){
		...
		var apiRoute = apiRoutes.controllers.SearchAction.getSearch($scope.query, $scope.pageNum);
